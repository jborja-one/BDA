...
import { reset, getReviews } from '../../features/reviews/reviewsSlice';
	...
	return (
		<div className="container-fluid ms-5 mt-100">
			<div className="position-relative">
				...
				<p
					className="reviews-behind-text_bar"
					data-aos="fade-left"
					data-aos-duration="2000"
					data-aos-easing="ease-in-back"></p>
				<p className="reviews-behind-text position-absolute">
					TESTIMONIALS
				</p>
			</div>
			<div
					...
					{reviews.map((review, i) => (
						<div
							...
							<div className="d-flex align-items-center ">
								<h1 className="lg-text bold-text mb-2 me-5">
									{review.fullName}
								</h1>
								<svg
							...
							<p className="md-text light-text mb-4">
								{review.service}
							</p>
							<p>
								{review.rating === 1 ? (
